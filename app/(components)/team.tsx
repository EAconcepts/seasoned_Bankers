...
const Team = () => {
  ...
  return (
    <div className="w-full py-[40px] px-[16px] bg-[#F7EAD6]">
      <h1 className="font-[600] text-[28px] leading-[33.6px] tracking-[2%] text-black">
        Meet The Team
      </h1>
      <Underline />
      {/* The Team */}
      <div className="w-full grid grid-cols-3 gap-[0px] mt-[40px] mb-[24px]">
          ...
          <div key={index} className="relative border-none w-full">
            ...
            <div className="absolute bottom-0 w-full px-[8px] bg-black/25 backdrop-blur-md shadow-[#42424240]">
              <div className="w-full flex flex-col items-end">
                <h3 className="text-[14px] font-[600] leading-[16.8px] tracking-[2%] text-white">
                  {team.name}
                </h3>
                <p className="text-white italic text-[10px] leading-[12px] tracking-[2%] font-[400]">
                  {team.role}
                </p>
              </div>
            </div>
      ...
      <ButtonOutline className="font-[700] bg-[#F7EAD6] text-[14px] leading-[16.8px] text-black h-fit py-[8px] px-[12px] -[24px] w-fit">
        See All Members
      </ButtonOutline>
    </div>
  );
