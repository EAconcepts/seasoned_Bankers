  ...
  return (
    <div className="flex  items-center mt-[40px] gap-x-[16px] text-[#8E98A8] ">
      ...
      >
        <span
          className={
            "lg:text-[24px] text-[16px] leading-[19.2px] lg:leading-[28.8px] tracking-[2%]"
          }
        >
          Previous
        </span>
        <span
          className={`size-[23.33px] flex items-center justify-center rounded-[4px] border-[#8E98A8] border-[1.5px] ${
            id && id > "1" && "text-primaryRed border-[#D7322C]"
          }`}
        >
      ...
      <button
        ...
        className={` flex gap-x-[16px] text-[#8E98A8] items-center ${
