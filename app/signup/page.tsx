    ...
    <div className="py-[40px] px-[16px] lg:px-[96px] mb-[24px] font-sofiaSans">
      ...
      <div className="mt-[24px] lg:mt-[40px]">
        ...
        <div>
          ...
          <Button disabled={registerMutation.isPending} onClick={()=>registerMutation.mutate()} className="text-[16px] lg:text-[24px] lg:leading-[28.8px] mt-[24px] lg:mt-[40px] font-[700] leading-[19.2px] px-[64px] py-[12px] lg:py-[16px] lg:px-[93px]">
            Next
          </Button>
        </div>
      </div>
